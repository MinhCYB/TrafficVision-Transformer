...
\coordinate (tokC) at (8.65, 3.15);
\coordinate (botC) at (11.45, 3.15);
\coordinate (tteC) at (15.95, 3.15);
\coordinate (decC) at (20.80, 3.15);
\coordinate (targetC) at (14.25, -2.25);
\coordinate (scoreC) at (20.80, -2.25);
...
% Spatial CLS tokens
% ---------------------------------------------------------------------
\node[smallnote] at ($(tokC)+(0,1.30)$) {Spatial\\CLS tokens};
\node[token] (z1) at ($(tokC)+(0,0.72)$) {$z_1$};
\node[token] (z2) at ($(tokC)+(0,0.00)$) {$z_2$};
\node[token] (z3) at ($(tokC)+(0,-0.72)$) {$z_3$};
\node[token] (z4) at ($(tokC)+(0,-1.44)$) {$z_4$};
...
\node[font=\sffamily\normalsize, text=black!68, align=center] at ($(botC)+(0,0.28)$)
    {Keep \textbf{1 CLS token}\\per frame};
...
\draw[main] (ste.east) -- (z2.west);
\draw[main] (z2.east) -- (bot.west);
\draw[main] (bot.east) -- (tte.west);
